...
The jar lands in `build/libs/mirage-1.4.0.jar`. Ignore the `-sources` one.
...
That writes `versions/26.2.properties` and builds `mirage-mc26.2-1.4.0.jar` beside the
...
Drop `mirage-1.4.0.jar` and the [Fabric API](https://modrinth.com/mod/fabric-api) jar into
